...
if (!isBot) {
  ...
  if (isUniqueUser) {
    ...
    const verifyHuman = () => {
      if (!verified) {
        verified = true;
        gtag('event', 'human_verified', { status: 'unique_user' });
...
window.dispatchEvent(new Event('toolsnova-auth-ready'));const footerLogin = document.getElementById('footerLogin');
const footerSignup = document.getElementById('footerSignup');
...
window.dispatchEvent(new Event('toolsnova-auth-ready'));const authLinks = document.getElementById('authLinks');
const userMenu = document.getElementById('userMenu');
const userGreeting = document.getElementById('userGreeting');
const logoutBtn = document.getElementById('logoutBtn');
const footerLogout = document.getElementById('footerLogout');
...
window.dispatchEvent(new Event('toolsnova-auth-ready'));      events.forEach(e => window.removeEventListener(e, verifyHuman));
    };
